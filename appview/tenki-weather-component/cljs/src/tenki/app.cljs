(ns tenki.app
  "tenki-weather-component appview — reagent + re-frame, view built from
  ...
  weather functionality that was not already there — see the repo README
  for the declared-vs-actual drift this scaffold still carries
  (`PROJECT.jsonld` / `kotodama.jsonld` describe routes and a component that
...
(def default-db
  {:heading "tenki-weather-component"
